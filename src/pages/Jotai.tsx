...
const Jotai = () => {
    ...
    return (
        <div className='w-[80%] m-auto'>
            <h1 className='font-bold text-4xl my-10'>Users List with Jotai</h1>
            ...
            <table className='w-full text-center shadow-2xl rounded-4xl'>
                ...
                <tbody className='py-4'>
                    {data.filter((e) => e.status.toString().includes(select)).filter((e) => e.name.toLowerCase().includes(search.toLowerCase())).map((e: IUser) => {
