...
import { ToDoListWithZus } from '../stores/ToDoListWithZus';
...
const Zustand = () => {
  ...
  const { data, deleteUser, changeStatus, addUser, editUser } = ToDoListWithZus()
  ...
  return (
    <div className='w-[80%] m-auto'>
      <h1 className='font-bold text-4xl my-10'>Users List with Zustand</h1>
