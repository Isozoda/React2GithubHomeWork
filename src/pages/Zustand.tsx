...
const Zustand = () => {
    const { data, GetData, DeleteData, AddNewUser, EditUser, search, select } = ToDoZustand()
    ...
    return (
        <>
            <h1 className='text-4xl font-bold mb-5'>Users Table Zustand</h1>
            <div className='flex mt-8 mb-5 items-center justify-between'>
                <Input onChange={(e) => search(e.target.value)} style={{ width: "350px" }} placeholder='Search...' />
                <Select
                    onChange={(e) => select(e)}
                    showSearch={{
                        ...
                        return <tr className='border-b border-b-gray-100 hover:bg-blue-100' key={e.id}>
                            ...
                            <td>
                                <div className='flex items-center gap-5 justify-center'>
                                    <svg onClick={() => DeleteData(e.id)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="red" className="size-6">
